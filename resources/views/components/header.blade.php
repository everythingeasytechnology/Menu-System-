...
<header class="flex h-20 shrink-0 items-center justify-between border-b border-border bg-card px-4 shadow-sm md:px-8">
    ...
    <div class="flex shrink-0 items-center gap-3">
        ...
        >
            ...
            >
                <span x-show="unreadCount > 0" class="absolute right-2 top-2 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-orange px-1 text-[9px] font-black leading-none text-white" x-text="unreadCount > 9 ? '9+' : unreadCount" style="display: none;"></span>
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
